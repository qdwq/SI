 ...
 */
final class Version20220525064635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks ADD category_id INT DEFAULT NULL, ADD tasks VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks DROP category_id, DROP tasks');
    }
}
